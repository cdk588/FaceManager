...
public class LogUtils {
    ...
    private static List<String> vecFile = new ArrayList<>();
    public static String customTagPrefix = "MyCustomLog"; // 自定义Tag的前缀，可以是作者名
    private static final boolean isSaveLog = false; // 是否把保存日志到SD卡中
    public static final String ROOT = Environment.getExternalStorageDirectory()
            .getPath() + "/MyCustomLog/"; // SD卡中的根目录
    //    public static final String ROOT = BASEFILEPATH + "/MyCustomLog/"; // SD卡中的根目录
    public static final String PATH_LOG_INFO = ROOT + "info/";
    public static final String PATH_LOG_INFO1 = ROOT + "info";
...
//                        new FileOutputStream(file, true), "unicode"));
    ...
    public static List<String> getFileName(String fileAbsolutePath) {
        getFiles(fileAbsolutePath, vecFile);
        return vecFile;
    }

    public static void getFiles(String fileAbsolutePath, List<String> vecFile) {
...
//        Log.e("ddd","文件名 ： " + filen);
        for (int iFileLength = 0; iFileLength < subFile.length; iFileLength++) {
            if (subFile[iFileLength].isDirectory()) {
                getFiles(fileAbsolutePath + "/" + subFile[iFileLength].getName(), vecFile);
            } else {
...
//                }
                vecFile.add(fileAbsolutePath + "/" + filename);
//                String s = fileAbsolutePath + "/" + filename;
//                Log.e("eee","文件名 ： " + s);
            }
        }
    }
